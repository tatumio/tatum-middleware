...
const tronBlockchainRouter = require('./api/tronBlockchainRouter');
const tronOffchainRouter = require('./api/tronOffchainRouter');
const ltcBlockchainRouter = require('./api/ltcBlockchainRouter');
const ltcOffchainRouter = require('./api/ltcOffchainRouter');
const dogeBlockchainRouter = require('./api/dogeBlockchainRouter');
const dogeOffchainRouter = require('./api/dogeOffchainRouter');
...
app.use('/v3/dogecoin', dogeBlockchainRouter);
app.use('/v3/offchain/dogecoin', dogeOffchainRouter);
app.use('/v3/tron', tronBlockchainRouter);
app.use('/v3/offchain/tron', tronOffchainRouter);
